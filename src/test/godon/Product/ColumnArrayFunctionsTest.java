...
public class ColumnArrayFunctionsTest {
    ...
    public void Test() throws Exception {
        ...
        columns.addProduct(new Column("일련번호"));
        columns.addProduct(new ComparableColumn("모델", ComparableColumn.ValueType.NUMBER));
        columns.addProduct(new Column("번호"));
        ...
        columns.addProduct(new Column("모델"));
